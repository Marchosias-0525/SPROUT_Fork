...
def train_evaluate_save_nn_model(file_path, target_column, model_path,  k_value):
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig(f'NeuralNetwork/SPROUT_Fork/b812/model/Fraction_Insertions_III/plot/learning_curve_k{k_value}.png')
    plt.show()
    ...
    plt.savefig(f'NeuralNetwork/SPROUT_Fork/b812/model/Fraction_Insertions_III/plot/prediction_vs_actual_k{k_value}.png')
    plt.show()
    ...
    plt.savefig(f'NeuralNetwork/SPROUT_Fork/b812/model/Fraction_Insertions_III/plot/residuals_k{k_value}.png')
    plt.show()
...
for k, file_path in zip(k_values, file_paths):
    model_path = f'NeuralNetwork/SPROUT_Fork/b812/model/Fraction_Insertions_III/nn_model_k{k}_{target_column}.h5'
...
results_df.to_csv('NeuralNetwork/SPROUT_Fork/b812/model/Fraction_Insertions_III/nn_model_evaluation_results_k2_k5.csv', index_label='k')
