...
def train_evaluate_save_nn_model(file_path, target_column, model_path,  k_value):
    ...
    history = model.fit(X_train, y_train, epochs=100, batch_size=32, validation_split=0.2, 
                        callbacks=[early_stopping, model_checkpoint, lr_scheduler_callback], verbose=1)
    ...
    plt.ylabel('Loss')
    plt.legend()
    plt.savefig(f'NeuralNetwork/SPROUT_Fork/b812/model/Fraction_Insertions_IV/plot/learning_curve_k{k_value}.png')
    plt.show()
    ...
    plt.savefig(f'NeuralNetwork/SPROUT_Fork/b812/model/Fraction_Insertions_IV/plot/prediction_vs_actual_k{k_value}.png')
    plt.show()
    ...
    plt.savefig(f'NeuralNetwork/SPROUT_Fork/b812/model/Fraction_Insertions_IV/plot/residuals_k{k_value}.png')
    plt.show()
...
for k, file_path in zip(k_values, file_paths):
    model_path = f'NeuralNetwork/SPROUT_Fork/b812/model/Fraction_Insertions_IV/nn_model_k{k}_{target_column}.h5'
...
results_df.to_csv('NeuralNetwork/SPROUT_Fork/b812/model/Fraction_Insertions_IV/nn_model_evaluation_results_k2_k5.csv', index_label='k')
